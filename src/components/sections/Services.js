					...
					<Col sm={12} md={4} className='text-white mt-5 mb-5'>
						<Link to='/services/interior-design'>
							<Card bg='dark' text='white' className='text-center' style={{ width: '20rem' }}>
								<Card.Img
									src={require('../images/interior-design.jpg').default}
									alt='Interior Design'
								/>
								<Card.ImgOverlay>
									<Card.Text>
						...
						<Link to='/services/exterior-design' style={{textDecoration:'none', color:'white'}}>
							<Card bg='dark' className='text-center' style={{ width: '20rem' }}>
								<Card.Img
									...
									src={require('../images/exterior-design.jpg').default}
									alt='Exterior Design'
								/>
								<Card.ImgOverlay>
				...
				<Row className='mt-3'>
					<Col sm={12} md={4} className='text-white mt-5 mb-5'>
						<Link to='/services/event-planning'>
							<Card bg='dark' text='white' className='text-center mb-5' style={{ width: '20rem' }}>
								<Card.Img
									src={require('../images/event-planning.jpg').default}
									alt='Event Planning'
								/>
								<Card.ImgOverlay>
									<Card.Text>
					...
					<Col sm={12} md={4} className='text-white mt-5 mb-5'>
						<Link to='/services/bureau-de-change'>
							<Card bg='dark' text='white' className='text-center mb-5' style={{ width: '20rem' }}>
								<Card.Img
									src={require('../images/bureau-de-change.jpg').default}
